...
Finally, we can take a high level view of all the nationalities (except "Other Nationalities") separately using a `facet_wrap()`. Since all the graphs are 
going to be tiny, we can remove the axes and tickmarks. 
